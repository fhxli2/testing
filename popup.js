...
if ( !this.shade )
this._make_shade();
var size = Element.getDimensions( this.options.parent );
...
if ( this.layer.id )
this.iframe.id = this.layer.id + '_blocking_iframe';
},
detach: function() {
...
var hide_method = this.hide.bind(this);
...
_onResize: function() {
if( this.options!=null && this.options.adjust_on_resize && this.layer!=null && this.layer.style!=null && this.layer.style.display != "none" ) {
...
if ( this.layer!=null && (offset[1] + this.layer.offsetHeight - constrain.bottom) > lower_right[1] ) {
if ( constrain.x && popup_align.x ) {
if ( constrain.anchor && anchor_align.x ) {
popup_offset.x = -popup_offset.x;
anchor_align.x = -anchor_align.x;
